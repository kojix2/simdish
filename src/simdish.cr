...
module SIMDish
  ...
  lib LibSIMDish
    # Vector addition using AVX2 for Float32 arrays
    fun simd_add(a : Float32*, b : Float32*, result : Float32*) : Void

    # Vector subtraction using AVX2 for Float32 arrays
    fun simd_sub(a : Float32*, b : Float32*, result : Float32*) : Void

    # Vector multiplication using AVX2 for Float32 arrays
    fun simd_mul(a : Float32*, b : Float32*, result : Float32*) : Void

    # Vector division using AVX2 for Float32 arrays
